...
<!--                          -->
            ...
            <!-- 
                    <li>
                      ...
                      <li>
                        <a  href="section.php"><i class="fa fa-desktop fa-3x"></i> PLACE</a>
                    </li>
                    <li>
                        <a  href="consumer.php"><i class="fa fa-qrcode fa-3x"></i> CONSUMER</a>
                    </li>
						   <li  >
                        <a  href="tariff.php"><i class="fa fa-bar-chart-o fa-3x"></i> TARIFF</a>
                    </li>	
                      <li  >
